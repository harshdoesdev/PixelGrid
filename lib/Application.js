...
export default class Application extends EventEmitter {
    ...
    addSystem(system) {
        this.systems.set(system.constructor.systemName, system);
        return this;
    }

    removeSystem(system) {
        this.systems(system.constructor.systemName, null);
        return this;
    }

    addTool(tool) {
        this.tools.set(tool.constructor.toolName, tool);
        return this;
    }
    ...
    setTool(toolName) {
        this.emit('toolChanged', toolName, this.currentTool?.constructor.toolName);
